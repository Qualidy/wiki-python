...
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/01_typen_prufen.yaml") }}
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/02_konkatinieren_von_strings.yaml") }}
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/03_konkatenieren_mit_trennzeichen.yaml") }}
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/04_gepaarte_summen.yaml") }}
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/05_beliebig_viele_zeilen_in_datei_speichern.yaml") }}
...
{{ task(file="tasks/python_grundlagen/args_kwargs/args_kwargs/06_args_zu_dictionary.yaml") }}
