...
{{ task(file="tasks/python_grundlagen/module/module/01_zufalle_gibts.yaml") }}
{{ task(file="tasks/python_grundlagen/module/module/02_abzocke_ausdenken.yaml") }}
{{ task(file="tasks/python_grundlagen/module/module/03_sicherheit_muss_sein.yaml") }}
{{ task(file="tasks/python_grundlagen/module/module/04_tische_bereit_machen.yaml") }}
