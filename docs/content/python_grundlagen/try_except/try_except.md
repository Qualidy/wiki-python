...
{{ youtube_video("https://www.youtube.com/embed/3FJFdrYjaX0?si=FbeKuSUYsv0D1F8K") }}
...
{{ youtube_video("https://www.youtube.com/embed/DS7sJ3dmfsM?si=r6kgIEED4k3INaeN") }}
...
{{ youtube_video("https://www.youtube.com/embed/6W3pegK1eBo?si=UhK6rQEE6HZsTulH") }}
...
{{ youtube_video("https://www.youtube.com/embed/W20lKG86D2A?si=-xSPKt83HYSEDywy") }}
...
{{ youtube_video("https://www.youtube.com/embed/h2yWcrSQ0KE?si=rBtDm0MDtc9iRiBG") }}
...
{{ youtube_video("https://www.youtube.com/embed/6NkV7dlwk08?si=6aReTT0-LLqt--jv") }}
...
{{ youtube_video("https://www.youtube.com/embed/5vKmhnx0JK4?si=ER7lCBtf2uSV5hI6") }}
...
{{ youtube_video("https://www.youtube.com/embed/NZcTFJmfiNw?si=j3V6e8TYkz80jqSk") }}
...
{{ task(file="tasks/python_grundlagen/try_except/try_except/01_benutzereingabe_und_integer_konvertierung.yaml") }}
{{ task(file="tasks/python_grundlagen/try_except/try_except/02_benutzerdefinierte_ausnahme.yaml") }}
{{ task(file="tasks/python_grundlagen/try_except/try_except/03_welche_fehler_kann_man_so_machen.yaml") }}
{{ task(file="tasks/python_grundlagen/try_except/try_except/04_sichere_benutzereingabe.yaml") }}
{{ task(file="tasks/python_grundlagen/try_except/try_except/05_ubertriebene_rekursion.yaml") }}
