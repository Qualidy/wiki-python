...
- [Exception Handling in Python](https://python-wiki.de/lehrplan/python_grundlagen/try_except/try_except.html)
- [Klassen](https://python-wiki.de/lehrplan/python_grundlagen/oop/define_classes/define_classes.html)
- [(Optional) Exkurs: Reguläre Ausdrücke](https://python-wiki.de/lehrplan/python_grundlagen/regex/regex.html)
