...
5. [Exkurs: Images verwalten](lehrplan/docker/images_verwalten.md) 
6. [Container Lebenszyklus](lehrplan/docker/lebenszyklus_der_docker_container.md) 
7. [Exkurs: Container Interaktion](lehrplan/docker/interaktion_mit_docker_containern.md) 
8. [Exkurs: Netzwerk und Kommunikation](lehrplan/docker/kommunikation_zwischen_und_mit_docker_containern.md) 
9. [Persistente Datenspeicherung](lehrplan/docker/wo_und_wie_docker_container_daten_speichern.md) 
10. [Exkurs: Fehlerbehebung und Logs](lehrplan/docker/fehlersuche_mit__container_logs.md) 
...
13. [Exkurs: Best Practices und Sicherheit](lehrplan/docker/best_practices_und_sicherheit.md)
