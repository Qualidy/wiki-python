...
def resort_within_word(words):
    ...
    for word in liste:
        ...
        liste.append(word)
    print(*liste)
    return liste # von Viktor eingefügt
resort_within_word('Hallo wie gehts')
...
def keep_smallest_biggest(my_list):
    ...
    my_list.clear()
    my_list.append(biggest)
    my_list.append(lowest)
    print(my_list)
    return my_list# von Viktor eingefügt

keep_smallest_biggest([1,3,4,88])
...
def count_letters(my_str):
    ...
    x=0
    for words in my_str:
        new_dict=my_dict.update(words, x)
        x+=1
    print(new_dict)
    return new_dict# von Viktor eingefügt
...
def funny_sum(my_list):
    ...
    for i in my_list:
        if i%2==0:
            ...
            x=x-i
    print(x)
    return x# von Viktor eingefügt
funny_sum([1,2,3,4,5,5])
