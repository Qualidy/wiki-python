...
# "2", 1 => None
def add_or_none(a, b):
    if a is (float or int) and b is (float or int):
        return a + b
    else:
        return None
...
def keys_with_string_values(my_dict):
    return [key for key, value in my_dict.items() if isinstance(value, str)]
...
def increment_numbers_in_string(input_string):
    for i in input_string:
        if i.isdigit():
            input_string = input_string.replace(i, str(int(i) + 1))
    return input_string          
...
def spoon(le):
    for i in le:
        if i == "a":
            return le.replace("a", "alawa")
        elif i == "e":
            return le.replace("e", "elewe")
        elif i == "i":
            return le.replace("i", "iliwi")
        elif i == "o":
            return le.replace("o", "olowo")
        elif i == "u":
            return le.replace("u", "uluwu")
        elif i == "ä":
            return le.replace("ä", "äläwä")
        elif i == "ü":
            return le.replace("ü", "ülüwü")
        elif i == "ö":
            return le.replace("ö", "ölöwö")
        elif i == "ei":
            return le.replace("ei", "eileiwei")
        else:
            return le
