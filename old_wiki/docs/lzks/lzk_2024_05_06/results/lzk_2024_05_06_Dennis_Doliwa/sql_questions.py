...
def size_of_class() -> str:
    ...
    return """
    SELECT COUNT(*) FROM schueler WHERE klasse_id = ?;
    """
...
def exams_in_timeframe():
    ...
    return """
    SELECT COUNT(*) FROM pruefungen WHERE pruefung.typ = 'Ex' AND pruefung.datum BETWEEN 2022_01_01 AND 2022_12_31;
    """
...
def all_klassensprecher():
    ...
    return"""
    SELECT schuelerin.rufname, schuelerin.familienname FROM schuelerin WHERE klasse.ist_klassensprecher
    """
...
def all_klassensprecher_sorted():
    ...
    return """
    SELECT schuelerin.rufname, schuelerin.familienname, klasse.id FROM schuelerin WHERE klasse.ist_klassensprecher ORDER BY schueler.familienname ASC, klasse.klassenbezeichnung ASC;
    """
