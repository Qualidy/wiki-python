...
def exams_in_timeframe():
    ...
    return """
SELECT Count(pruefung.id)
FROM pruefung
Where pruefung.datum between ? and ?
and pruefung.typ LIKE 'EX'
"""
...
FROM schuelerin
Where ist_klassensprecher LIKE '1'
"""
...
#     ('Hans', 'Gustav', 1.5)"""
#     return """
# SELECT rufname, familienname ,avg(wert) as Durschnittsnote
# FROM lehrkraft
# JOIN note on lehrkraft.id = note.lehrkraft_id
# GROUP BY familienname
# Order by Durschnittsnote ASC
# """
#
