...
def size_of_class() -> str:
    ...
    return """SELECT count(schuelerin.klasse_id) FROM schuelerin WHERE klasse_id='6a' OR klasse_id='8b'OR klasse_id='14a'"""
...
def exams_in_timeframe():
    ...
    return """SELECT COUNT(laufende_nr) FROM pruefung WHERE datum BETWEEN ?  AND ? AND  typ= 'Ex'"""
