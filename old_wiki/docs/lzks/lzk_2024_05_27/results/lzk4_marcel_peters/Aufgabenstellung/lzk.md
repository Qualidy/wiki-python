...
* `<span style="color:red">`**Hinweis:** Vergiss nicht, deine `translator.py` zu starten. Von nun an teste deine Website im Browser **über den Flask Server** (Route '/')! `<br>`
